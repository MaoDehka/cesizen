...
if($updated==1)
{
		...
		<div class="modal-dialog " role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a href="index.php?action=logout"><button type="button" class="btn btn-danger"><i class="fa fa-power-off"></i> '.T_('Déconnexion').'</button></a>
	...
	<script>
		$(document).ready(function(){
			$("#modify_pwd").modal({backdrop: \'static\', keyboard: false}, \'show\');
		});
	</script>
	';
}
