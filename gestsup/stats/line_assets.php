...
tassets.disable='0'");
$qry->execute(array('company' => $_POST['company'],'technician' => $_POST['tech'],'type' => $_POST['type'],'model' => $_POST['model'],'netbios' => $_POST['netbios'],'department' => $_POST['service'],'date_install' => "$_POST[year]-$_POST[month]-%"));
$row=$qry->fetch();
$qry->closeCursor();
$count=$row[0];
...
tassets.disable='0'");
$qry->execute(array('company' => $_POST['company'],'technician' => $_POST['tech'],'type' => $_POST['type'],'model' => $_POST['model'],'netbios' => $_POST['netbios'],'department' => $_POST['service'],'date_recycle' => "$_POST[year]-$_POST[month]-%"));
$row=$qry->fetch();
$qry->closeCursor();
$count2=$row[0];
...
tassets.department LIKE :department AND 
tassets.disable='0'");
$qry->execute(array('company' => $_POST['company'],'technician' => $_POST['tech'],'type' => $_POST['type'],'model' => $_POST['model'],'netbios' => $_POST['netbios'],'department' => $_POST['service']));
$row=$qry->fetch();
$qry->closeCursor();
$count4=$row[0];
...
if (($_POST['month'] == '%') && ($_POST['year']!=='%'))
{
	...
	$query1=$db->query("SELECT month(tassets.date_install) AS x,count(*) AS y FROM `tassets`,`tusers` WHERE tassets.user=tusers.id AND tusers.company LIKE '$_POST[company]' AND tassets.technician LIKE '$_POST[tech]' AND tassets.department LIKE '$_POST[service]' AND tassets.type LIKE '$_POST[type]' AND tassets.model LIKE '$_POST[model]' AND tassets.netbios LIKE '$_POST[netbios]' AND tassets.date_install LIKE '$_POST[year]-$_POST[month]-%' AND tassets.disable='0' GROUP BY x ");
	$query2=$db->query("SELECT month(tassets.date_recycle) AS x,count(*) AS y FROM `tassets`,`tusers` WHERE tassets.user=tusers.id AND tusers.company LIKE '$_POST[company]' AND tassets.technician LIKE '$_POST[tech]' AND tassets.department LIKE '$_POST[service]' AND tassets.type LIKE '$_POST[type]' AND tassets.model LIKE '$_POST[model]' AND tassets.netbios LIKE '$_POST[netbios]' AND tassets.date_recycle NOT LIKE '0000-00-00 00:00:00' AND tassets.date_recycle LIKE '$_POST[year]-$_POST[month]-%' AND tassets.disable='0' GROUP BY x ");
...
else if ($_POST['month']!='%')
{
	...
	$query1=$db->query("SELECT day(tassets.date_install) AS x,count(*) AS y FROM `tassets`,`tusers` WHERE tassets.user=tusers.id AND tusers.company LIKE '$_POST[company]' AND tassets.technician LIKE '$_POST[tech]' AND tassets.department LIKE '$_POST[service]' AND tassets.type LIKE '$_POST[type]' AND tassets.model LIKE '$_POST[model]' AND tassets.netbios LIKE '$_POST[netbios]' AND tassets.date_install LIKE '$_POST[year]-$_POST[month]-%' AND tassets.disable='0' GROUP BY x ");
...
else if ($_POST['year']=='%')
{
	...
	$query1=$db->query("SELECT YEAR(tassets.date_install) AS x,count(*) AS y FROM `tassets`,`tusers` WHERE tassets.user=tusers.id AND tusers.company LIKE '$_POST[company]' AND tassets.technician LIKE '$_POST[tech]' AND tassets.department LIKE '$_POST[service]' AND tassets.type LIKE '$_POST[type]' AND tassets.model LIKE '$_POST[model]' AND tassets.netbios LIKE '$_POST[netbios]' AND tassets.date_install LIKE '$_POST[year]-$_POST[month]-%' AND tassets.disable='0' GROUP BY x ");
